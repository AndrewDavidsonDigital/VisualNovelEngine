...
import { onMounted, ref, watch } from 'vue';
  ...
  type EffectType = 'off' | 'warning' | 'good-bad' | 'old-school' | 'monochrome' | 'glitch';
...
<style scoped>
  ...
  .glitch{
    ...
    --glitchClipPath1: polygon(
      ...
      14% 100%, 14% 55%, 17% 55%, 17% 70%, 20% 70%, 20% 45%, 17% 45%, 17% 51%, 14% 51%, 14% 100%,  /* left-inner */
      23% 100%, 23% 94%, 41% 94%, 41% 96%, 55% 96%, 55% 100%, 
      67% 100%, 67% 51%, 73% 51%, 73% 42%, 67% 42%, 67% 51%, 56% 51%, 56% 58%, 67% 58%, 67% 100%,  /* right-inner */ 
      ...
      --glitchClipPath3: var(--glitchClipPath1);
    /*
      --glitchClipPath2: polygon(-2% 0%, 7% 0%, 7% 3%, -2% 3%, -2% 17%, 12% 17%, 12% 23%, 15% 23%, 15% 28%, 9% 28%, 9% 22%, -2% 22%, -2% 34%, 2% 34%, 2% 42%, -2% 42%, -2% 52%, 5% 52%, 5% 58%, 3% 58%, 3% 66%, -2% 66%, -2% 83%, 11% 83%, 11% 77%, 14% 77%, 14% 89%, -2% 89%, -2% 96%, 5% 96%, 5% 100%, -2% 100%, 14% 100%, 14% 55%, 17% 55%, 17% 70%, 20% 70%, 20% 45%, 17% 45%, 17% 51%, 14% 51%, 14% 100%, 23% 100%, 23% 93%, 41% 93%, 41% 96%, 55% 96%, 55% 100%, 67% 100%, 67% 51%, 73% 51%, 73% 42%, 67% 42%, 67% 51%, 56% 51%, 56% 58%, 67% 58%, 67% 100%, 73% 100%, 73% 94%, 78% 94%, 78% 84%, 80% 84%, 80% 100%, 86% 100%, 86% 90%, 96% 90%, 96% 94%, 90% 94%, 90% 100%, 100% 100%, 100% 84%, 95% 84%, 95% 72%, 98% 72%, 98% 80%, 100% 80%, 100% 66%, 90% 66%, 90% 61%, 100% 61%, 100% 56%, 96% 56%, 96% 50%, 98% 50%, 98% 36%, 100% 36%, 100% 25%, 93% 25%, 93% 20%, 98% 20%, 98% 14%, 100% 14%, 100% 6%, 95% 6%, 95% 10%, 93% 10%, 93% 0%, 100% 0%, 100% 100%, -2% 100%);
      --glitchClipPath3: polygon(-2% 0%, 11% 0, 11% 3%, 0 3%, -2% 17%, 7% 17%, 7% 22%, 14% 22%, 14% 25%, 4% 25%, 4% 22%, -2% 22%, -2% 34%, 2% 34%, 2% 46%, 0 46%, -2% 52%, 6% 52%, 6% 58%, 2% 58%, 2% 66%, -2% 66%, -2% 83%, 11% 83%, 11% 77%, 14% 77%, 14% 89%, -2% 89%, -2% 96%, 7% 96%, 7% 100%, -2% 100%, 14% 100%, 14% 60%, 17% 60%, 17% 70%, 19% 70%, 19% 49%, 17% 49%, 17% 55%, 14% 55%, 14% 100%, 25% 100%, 25% 93%, 37% 93%, 37% 96%, 51% 96%, 51% 100%, 67% 100%, 67% 54%, 77% 54%, 77% 46%, 67% 46%, 67% 51%, 62% 52%, 62% 62%, 67% 62%, 67% 100%, 73% 100%, 73% 94%, 78% 94%, 78% 84%, 80% 84%, 80% 100%, 88% 100%, 88% 90%, 96% 90%, 96% 94%, 92% 94%, 92% 100%, 100% 100%, 100% 84%, 95% 84%, 95% 72%, 98% 72%, 100% 72%, 100% 80%, 100% 66%, 90% 66%, 90% 61%, 100% 61%, 100% 56%, 96% 56%, 96% 50%, 98% 50%, 98% 36%, 100% 36%, 100% 25%, 95% 25%, 95% 20%, 98% 20%, 98% 16%, 100% 16%, 100% 10%, 95% 10%, 92% 6%, 88% 6%, 88% 0, 100% 0%, 100% 100%, -2% 100%); */
  ...
  .glitch2{
    ...
    clip-path:polygon(-2% 0%, 7% 0%, 7% 6%, -2% 6%, -2% 17%, 12% 17%, 12% 23%, 15% 23%, 15% 28%, 9% 28%, 9% 22%, -2% 22%, -2% 34%, 2% 34%, 2% 42%, -2% 42%, -2% 52%, 5% 52%, 5% 58%, 3% 58%, 3% 66%, -2% 66%, -2% 83%, 11% 83%, 11% 77%, 14% 77%, 14% 89%, -2% 89%, -2% 96%, 5% 96%, 5% 100%, -2% 100%, 14% 100%, 14% 55%, 17% 55%, 17% 70%, 20% 70%, 20% 45%, 17% 45%, 17% 51%, 14% 51%, 14% 100%, 23% 100%, 23% 93%, 41% 93%, 41% 96%, 55% 96%, 55% 100%, 67% 100%, 67% 51%, 73% 51%, 73% 42%, 67% 42%, 67% 51%, 56% 51%, 56% 58%, 67% 58%, 67% 100%, 73% 100%, 73% 94%, 78% 94%, 78% 84%, 80% 84%, 80% 100%, 86% 100%, 86% 90%, 96% 90%, 96% 94%, 90% 94%, 90% 100%, 100% 100%, 100% 84%, 95% 84%, 95% 72%, 98% 72%, 98% 80%, 100% 80%, 100% 66%, 90% 66%, 90% 61%, 100% 61%, 100% 56%, 96% 56%, 96% 50%, 98% 50%, 98% 36%, 100% 36%, 100% 25%, 93% 25%, 93% 20%, 98% 20%, 98% 14%, 100% 14%, 100% 6%, 95% 6%, 95% 10%, 93% 10%, 93% 0%, 100% 0%, 100% 100%, -2% 100%);
  }
