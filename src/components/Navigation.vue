...
<template>
  <nav class="flex flex-col gap-5">
    ...
    <Clickable><RouterLink to="/options" class="hover:text-orange-400">Options</RouterLink></Clickable>
    <Clickable><RouterLink to="/exit" class="hover:text-orange-400">Exit</RouterLink></Clickable>
  </nav>
</template>
