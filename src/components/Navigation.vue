...
<template>
  <nav class="flex flex-col gap-5 interactable-styling">
    ...
    <span v-else class="pointer-events-none text-gray-300"><a class="italic">Continue</a></span>
    <Clickable v-if="hasSaves"><RouterLink to="/menu">Load Game</RouterLink></Clickable>
    <span v-else class="pointer-events-none text-gray-300"><a class="italic">NYI: Load Game</a></span>
